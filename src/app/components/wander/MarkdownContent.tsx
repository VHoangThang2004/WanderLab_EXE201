 ...
 * Hỗ trợ: bold, italic, code inline, code block, lists, headers, links.
 * Không cần thêm dependency (react-markdown) — nhẹ và đủ dùng.
 */
...
interface ParsedBlock {
  type: 'paragraph' | 'heading' | 'code-block' | 'list' | 'hr';
